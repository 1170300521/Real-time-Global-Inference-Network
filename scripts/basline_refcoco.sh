...
python code/main_dist.py "baseline" --ds_to_use='refcoco' --bs=32 --nw=8 --epochs=20 --mdl_to_use="baseline" --resume=True --load_opt=True  --resize_img="[320, 320]" --use_att_loss=False
