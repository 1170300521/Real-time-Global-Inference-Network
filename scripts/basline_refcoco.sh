CUDA_VISIBLE_DEVICES=0,1 python code/main_dist.py "baseline_garan" --ds_to_use='refcoco' --bs=24 --nw=4 --epochs=20 --mdl_to_use="baseline" --resize_img="[320, 320]" --use_att_loss=False
