#python code/main_dist.py "refclef" --ds_to_use='refclef' --bs=16 --nw=4 --epochs=20 --lstm_dim=128 --img_dim=256 --lang_to_use="lstm"
#python code/main_dist.py "refclef" --ds_to_use='refclef' --bs=8 --nw=4 --resume=True --resize_img="[608,608]"
python code/main_dist.py "refclef" --ds_to_use='refclef' --bs=16 --nw=4 --resume=True --resize_img="[320, 320]" --only_val=True --lstm_dim=128 --img_dim=256 --lang_to_use="lstm"
